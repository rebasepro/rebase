...
and `cards` ([view_mode.ts:99](../packages/admin/src/util/view_mode.ts#L99)).
...
2. **No grouping primitive exists.** 25 fields render as one undifferentiated
   ...
   ([FormLayout.tsx](../packages/admin/src/form/components/FormLayout.tsx)).
3. **The only width knob is `admin.widthPercentage`** — a raw percentage fed to
   `calc(X% - 8px)` in a wrapping flex row
   ([FormEntry.tsx:14](../packages/admin/src/form/components/FormEntry.tsx#L14)).
...
6. **The path chip renders `posts/`** — a bare trailing slash. It is
   ...
   ([EntityForm.tsx:491](../packages/admin/src/form/EntityForm.tsx#L491)).
7. **The heading of a new blog post reads `draft`.** The title resolver walks
   ...
   ([EntityForm.tsx:319-329](../packages/admin/src/form/EntityForm.tsx#L319),
...
8. **The id can appear three times.** On `customers` (which uses
   ...
   ([EntityViewBinding.tsx:38-61](../packages/admin/src/components/EntityViewBinding.tsx#L38)),
...
10. `buildSideActions` is a fixed `w-80 2xl:w-96` sticky column
    ([EntityFormActions.tsx:183](../packages/admin/src/form/EntityFormActions.tsx#L183))
...
11. The sync-status indicator is an **unlabelled sticky circle** (✓ / pencil /
    ...
    ([EntityForm.tsx:593](../packages/admin/src/form/EntityForm.tsx#L593)). It
...
12. **Tab order is `[JSON] [History] [Entity] [custom…] [subcollections]`**
    ([EditViewBinding.tsx:645-673](../packages/admin/src/components/EditViewBinding.tsx#L645)).
...
18. **`selectedTab` doubles as "am I editing"** — `selectedTab === "edit"`
    ([SidePanelBinding.tsx:102](../packages/admin/src/components/SidePanelBinding.tsx#L102)).
...
([EditViewBinding.tsx:232-301](../packages/admin/src/components/EditViewBinding.tsx#L232)).
...
([SidePanelBinding.tsx:144-168](../packages/admin/src/components/SidePanelBinding.tsx#L144)).
...
20. **`entityViews` and `formView` are two concepts with near-identical
    ...
    [EditViewBinding.tsx:462](../packages/admin/src/components/EditViewBinding.tsx#L462)).
    ...
    ([entity_views.tsx:80,104](../packages/admin-types/src/types/entity_views.tsx#L80)).
21. **`EntityCustomViewParams` hands you three overlapping views of the same
    ...
    [EditViewBinding.tsx:374](../packages/admin/src/components/EditViewBinding.tsx#L374),
    `formContext.values ?? entity.values` at
    [:393](../packages/admin/src/components/EditViewBinding.tsx#L393) and
    [:408](../packages/admin/src/components/EditViewBinding.tsx#L408).
...
- When it does not: no rail. Save/Discard go in the persistent bar (⌘S is
  already wired at [EntityForm.tsx:222](../packages/admin/src/form/EntityForm.tsx#L222)).
...
`selectedTab === "edit"` ([SidePanelBinding.tsx:102](../packages/admin/src/components/SidePanelBinding.tsx#L102))
