...
export const authors = pgTable("authors", {
    ...
    pgPolicy("authors_public_access", { as: "permissive",
for: "all",
to: ["public"],
using: sql`true`,
withCheck: sql`true` })
...
mode: "string" }).notNull(),
    shipped_date: timestamp("shipped_date", { withTimezone: true,
mode: "string" }),
    delivered_date: timestamp("delivered_date", { withTimezone: true,
mode: "string" }),
    created_at: timestamp("created_at", { withTimezone: true,
mode: "string" }).default(sql`now()`),
    updated_at: timestamp("updated_at", { withTimezone: true,
...
export const productLocales = pgTable("product_locales", {
    ...
    pgPolicy("product_locales_public_access", { as: "permissive",
for: "all",
to: ["authenticated"],
using: sql`true`,
withCheck: sql`true` })
...
export const tags = pgTable("tags", {
    ...
    pgPolicy("tags_public_access", { as: "permissive",
for: "all",
to: ["authenticated"],
using: sql`true`,
withCheck: sql`true` })
...
tickets,
users };
export const enums = { exercisesDifficulty,
exercisesCategory,
exercisesStatus,
ordersStatus,
