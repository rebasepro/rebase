...
#
#   ./scripts/deprecate-old-packages.sh --dry-run   # audit; writes nothing
#   ./scripts/deprecate-old-packages.sh             # npm opens a browser once
#
...
#
# This mirrors RENAMED in scripts/headless-guard/check-package-names.mjs, which
