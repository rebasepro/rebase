...
/** Junk an agent leaves behind. AGENT.md forbids one-off scripts outside scripts/. */
...
export function grade({ task, split, passed, diff, trace, verifyOutput }) {
    ...
    if (litter.length) {
        notes.push(`Left one-off files in the repo root: ${litter.join(", ")} (AGENT.md: use scripts/).`);
        score -= 15;
    }
