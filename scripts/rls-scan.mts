 ...
 * reason `scripts/verify-selfhost.mts` does it.
 */
...
const DEFAULT_BASELINE = path.join(ROOT, "scripts", "rls-baseline.json");
...
Options
  --baseline <path|none>  Accepted findings. Default: scripts/rls-baseline.json.
