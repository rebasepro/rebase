...
export async function render(): Promise<string> {
    ...
    return [
        ...
        "#",
        "# Every line is a name this framework derives and writes into a customer's",
        "# database. A line that CHANGES or DISAPPEARS is a break: databases in the",
        "# field carry the old name, and no release can reach in and rename them.",
        "# See docs/compatibility.md, contract 6.",
        "#",
