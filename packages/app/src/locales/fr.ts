...
export const fr: RebaseTranslations = {
    ...
    selection_selected_count: "{{selected}} sélectionnés",
    selection_select_all_loaded: "Sélectionner les lignes chargées",
    selection_deselect_all: "Tout désélectionner",
    selection_select_all_matching: "Sélectionner les {{total}} {{collection}}",
    selection_select_all_matching_unknown: "Sélectionner toutes les lignes correspondantes",
    selection_all_matching_selected: "Les {{total}} {{collection}} sont sélectionnés",
    selection_all_matching_selected_unknown: "Toutes les lignes correspondant au filtre actuel sont sélectionnées",
