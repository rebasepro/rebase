...
export const pt: RebaseTranslations = {
    ...
    auth_account_exists_with_different_credential: "Já existe uma conta com este email. Inicie sessão como fez da última vez.",
    auth_account_exists_sign_in_with_password: "Já existe uma conta com este email. Inicie sessão com o seu email e palavra-passe.",
    ...
    auth_new_password_title: "Definir uma nova palavra-passe",
    auth_new_password_subtitle: "Escolha a palavra-passe com que vai iniciar sessão a partir de agora.",
    auth_password_requirements: "A palavra-passe deve ter pelo menos 8 caracteres, com maiúsculas, minúsculas e um número",
    auth_set_password: "Definir palavra-passe",
    auth_password_changed_title: "Palavra-passe alterada",
    auth_password_changed_body: "Inicie sessão com a sua nova palavra-passe.",
    auth_continue_to_sign_in: "Continuar para iniciar sessão",
    auth_link_invalid_or_expired: "Esta ligação é inválida ou expirou. Peça uma nova no ecrã de início de sessão.",
    auth_password_reset_unavailable: "A reposição da palavra-passe não está disponível neste backend.",
    auth_verifying_email: "A confirmar o seu endereço de email…",
    auth_email_verified_title: "Email confirmado",
    auth_email_verified_body: "O seu endereço de email está confirmado. Já pode iniciar sessão.",
    auth_email_verification_failed_title: "Email não confirmado",
    auth_email_verification_unavailable: "A verificação de email não está disponível neste backend.",
    auth_mfa_title: "Verificação em dois passos",
    auth_mfa_subtitle: "Introduza o código da sua aplicação de autenticação ou um dos seus códigos de recuperação.",
    auth_mfa_factor_label: "Verificar com",
    auth_mfa_factor_totp: "Aplicação de autenticação",
    auth_mfa_code_label: "Código de verificação",
    auth_mfa_verify: "Verificar",
    auth_mfa_code_invalid: "Esse código não está correto. Experimente o código atual da sua aplicação de autenticação ou um código de recuperação.",
    auth_mfa_challenge_exhausted: "Demasiados códigos errados. Introduza um novo código da sua aplicação de autenticação para tentar novamente.",
    auth_mfa_expired: "Este início de sessão expirou. Inicie sessão novamente para continuar.",
    auth_mfa_sign_in_again: "Iniciar sessão novamente",
    ...
    studio_sql_explain_single_statement: "O Explain funciona com uma instrução de cada vez. Selecione a instrução a explicar e tente novamente.",
    ...
    studio_rls_edit_generated: "{{policy}} é gerada pelo Rebase para todas as coleções, por isso não há nenhuma regra sua para editar. Adicione antes uma política sua.",
    studio_rls_edit_not_declared: "{{policy}} existe apenas na base de dados, por isso não há nenhuma regra no seu código para editar. Importe-a primeiro para o código.",
    studio_rls_edit_several_operations: "{{policy}} é uma das políticas em que uma única regra é compilada, uma por operação. Edite essa regra no ficheiro de origem da coleção.",
    ...
    studio_cron_logs_read_failed: "Não foi possível ler as execuções desta tarefa",
    studio_cron_logs_denied_title: "Não pode ler as execuções desta tarefa",
    ...
    studio_api_keys_inactive_heading: "Revogadas / Expiradas",
