...
export const pt: RebaseTranslations = {
    ...
    selection_selected_count: "{{selected}} selecionados",
    selection_select_all_loaded: "Selecionar as linhas carregadas",
    selection_deselect_all: "Desmarcar tudo",
    selection_select_all_matching: "Selecionar todos os {{total}} {{collection}}",
    selection_select_all_matching_unknown: "Selecionar todas as linhas correspondentes",
    selection_all_matching_selected: "Todos os {{total}} {{collection}} estão selecionados",
    selection_all_matching_selected_unknown: "Todas as linhas que correspondem ao filtro atual estão selecionadas",
    selection_clear: "Limpar seleção",
