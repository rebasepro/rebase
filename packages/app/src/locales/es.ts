...
export const es: RebaseTranslations = {
    ...
    selection_selected_count: "{{selected}} seleccionados",
    selection_select_all_loaded: "Seleccionar las filas cargadas",
    selection_deselect_all: "Deseleccionar todo",
    selection_select_all_matching: "Seleccionar los {{total}} {{collection}}",
    selection_select_all_matching_unknown: "Seleccionar todas las filas coincidentes",
    selection_all_matching_selected: "Se han seleccionado los {{total}} {{collection}}",
    selection_all_matching_selected_unknown: "Se han seleccionado todas las filas que coinciden con el filtro actual",
    selection_clear: "Anular la selección",
