...
export const es: RebaseTranslations = {
    ...
    entity_not_found_body: "Este registro no existe, o puede estar oculto para ti por la seguridad a nivel de fila.",
    back_to_collection: "Volver a {{name}}",
    ...
    auth_account_exists_with_different_credential: "Ya existe una cuenta con este correo electrónico. Inicia sesión como lo hiciste la última vez.",
    auth_account_exists_sign_in_with_password: "Ya existe una cuenta con este correo electrónico. Inicia sesión con tu correo electrónico y contraseña.",
    ...
    auth_new_password_title: "Establece una nueva contraseña",
    auth_new_password_subtitle: "Elige la contraseña con la que iniciarás sesión a partir de ahora.",
    auth_password_requirements: "La contraseña debe tener al menos 8 caracteres, con mayúsculas, minúsculas y un número",
    auth_set_password: "Establecer contraseña",
    auth_password_changed_title: "Contraseña cambiada",
    auth_password_changed_body: "Inicia sesión con tu nueva contraseña.",
    auth_continue_to_sign_in: "Continuar al inicio de sesión",
    auth_link_invalid_or_expired: "Este enlace no es válido o ha caducado. Solicita uno nuevo desde la pantalla de inicio de sesión.",
    auth_password_reset_unavailable: "El restablecimiento de contraseña no está disponible en este backend.",
    auth_verifying_email: "Confirmando tu dirección de correo…",
    auth_email_verified_title: "Correo confirmado",
    auth_email_verified_body: "Tu dirección de correo está confirmada. Ya puedes iniciar sesión.",
    auth_email_verification_failed_title: "Correo no confirmado",
    auth_email_verification_unavailable: "La verificación de correo no está disponible en este backend.",
    auth_mfa_title: "Verificación en dos pasos",
    auth_mfa_subtitle: "Introduce el código de tu aplicación de autenticación o uno de tus códigos de recuperación.",
    auth_mfa_factor_label: "Verificar con",
    auth_mfa_factor_totp: "Aplicación de autenticación",
    auth_mfa_code_label: "Código de verificación",
    auth_mfa_verify: "Verificar",
    auth_mfa_code_invalid: "Ese código no es correcto. Prueba el código actual de tu aplicación de autenticación o un código de recuperación.",
    auth_mfa_challenge_exhausted: "Demasiados códigos incorrectos. Introduce un código nuevo de tu aplicación de autenticación para volver a intentarlo.",
    auth_mfa_expired: "Este inicio de sesión ha caducado. Vuelve a iniciar sesión para continuar.",
    auth_mfa_sign_in_again: "Volver a iniciar sesión",
    ...
    studio_rls_edit_generated: "Rebase genera {{policy}} para todas las colecciones, así que no hay ninguna regla tuya que editar. Añade una política propia en su lugar.",
    studio_rls_edit_not_declared: "{{policy}} solo existe en la base de datos, así que no hay ninguna regla en tu código que editar. Impórtala primero al código.",
    studio_rls_edit_several_operations: "{{policy}} es una de las políticas en las que se compila una sola regla, una por operación. Edita esa regla en el archivo fuente de la colección.",
    ...
    studio_group_views: "Vistas",
    studio_group_admin: "Administración",
    studio_group_settings: "Ajustes",
    ...
    studio_cron_logs_read_failed: "No se han podido leer las ejecuciones de esta tarea",
    studio_cron_logs_denied_title: "No puedes leer las ejecuciones de esta tarea",
    ...
    studio_api_keys_empty_title: "Aún no hay claves de API",
    studio_api_keys_empty_hint: "Cree una clave para habilitar la autenticación entre servicios",
    studio_api_keys_revoke: "Revocar",
    studio_api_keys_select_hint: "Seleccione una clave de API para ver los detalles",
    studio_api_keys_permissions: "Permisos",
    studio_api_keys_no_permissions: "No hay permisos configurados",
    studio_api_keys_revoke_confirmation: "Confirmación de revocación",
    studio_api_keys_name_label: "Nombre:",
    studio_api_keys_access_label: "Acceso:",
    studio_api_keys_admin_granted: "Rol de administrador concedido",
    studio_api_keys_admin_granted_hint: "las rutas de administración y las políticas default_admin",
    studio_api_keys_done: "Listo",
    studio_api_keys_status_active: "Activa",
    studio_api_keys_status_expired: "Caducada",
    studio_api_keys_status_revoked: "Revocada",
    studio_api_keys_inactive_heading: "Revocadas / Caducadas",
    studio_api_keys_stat_status: "Estado",
    studio_api_keys_stat_last_used: "Último uso",
    studio_api_keys_stat_expires: "Caduca",
    studio_api_keys_never: "Nunca",
    studio_api_keys_role_service: "Servicio",
    studio_api_keys_stat_rate_limit: "Límite de peticiones",
    studio_api_keys_rate_limit_default: "Predeterminado (1000/15 min)",
    studio_api_keys_stat_created_by: "Creada por",
    studio_api_keys_copy_failed: "No se pudo copiar",
