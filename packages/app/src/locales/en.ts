...
export const en: RebaseTranslations = {
    ...
    auth_account_exists_with_different_credential: "An account with this email already exists. Sign in the way you did before.",
    auth_account_exists_sign_in_with_password: "An account with this email already exists. Sign in with your email and password instead.",
    ...
    auth_new_password_subtitle: "Choose the password you will sign in with from now on.",
    auth_password_requirements: "Password must be 8+ characters with uppercase, lowercase, and a number",
    auth_set_password: "Set password",
    auth_password_changed_title: "Password changed",
    auth_password_changed_body: "Sign in with your new password.",
    auth_continue_to_sign_in: "Continue to sign in",
    auth_link_invalid_or_expired: "This link is invalid or has expired. Request a new one from the sign-in screen.",
    auth_password_reset_unavailable: "Password reset is not available on this backend.",
    auth_verifying_email: "Confirming your email address…",
    auth_email_verified_title: "Email confirmed",
    auth_email_verified_body: "Your email address is confirmed. You can sign in now.",
    auth_email_verification_failed_title: "Email not confirmed",
    auth_email_verification_unavailable: "Email verification is not available on this backend.",
    auth_mfa_title: "Two-step verification",
    auth_mfa_subtitle: "Enter the code from your authenticator app, or one of your recovery codes.",
    auth_mfa_factor_label: "Verify with",
    auth_mfa_factor_totp: "Authenticator app",
    auth_mfa_code_label: "Verification code",
    auth_mfa_verify: "Verify",
    auth_mfa_code_invalid: "That code is not right. Try the current code from your authenticator app, or a recovery code.",
    auth_mfa_challenge_exhausted: "Too many wrong codes. Enter a new code from your authenticator app to try again.",
    auth_mfa_expired: "This sign-in has expired. Sign in again to continue.",
    auth_mfa_sign_in_again: "Sign in again",
    ...
    studio_rls_edit_generated: "{{policy}} is generated by Rebase for every collection, so there is no rule of yours to edit. Add a policy of your own instead.",
    studio_rls_edit_not_declared: "{{policy}} exists only in the database, so there is no rule in your code to edit. Import it to the codebase first.",
    studio_rls_edit_several_operations: "{{policy}} is one of the policies a single rule compiles to, one per operation. Edit that rule in the collection's source file.",
    ...
    studio_group_access_control: "Access Control",
    studio_tool_sql: "SQL Console",
    studio_tool_sql_description: "Execute SQL queries",
    studio_tool_js: "JS Console",
    studio_tool_js_description: "Execute JavaScript",
    studio_tool_rls: "RLS Policies",
    studio_tool_rls_description: "Row Level Security",
    studio_tool_storage: "Storage",
    studio_tool_storage_description: "Manage storage files",
    ...
    studio_tool_backups_description: "Download database backups",
    studio_tool_api: "API Explorer",
    studio_tool_api_description: "Interactive API documentation and testing",
    studio_tool_logs: "Logs Explorer",
    studio_tool_logs_description: "Real-time system and query logs",
    studio_tool_api_keys: "API Keys",
    studio_tool_api_keys_description: "Create and manage scoped API keys",
    studio_backups_denied_title: "You cannot list this project's backups",
    ...
    studio_cron_logs_read_failed: "Could not read this job's executions",
    studio_cron_logs_denied_title: "You cannot read this job's executions",
    studio_api_keys_denied_title: "You cannot list this project's API keys",
    studio_api_keys_denied_hint: "Nothing is wrong with the project. Managing API keys is an admin operation, and the signed-in account was refused.",
    studio_api_keys_read_failed: "Could not read this project's API keys",
    studio_api_keys_empty_title: "No API keys yet",
    studio_api_keys_empty_hint: "Create a key to enable machine-to-machine authentication",
    studio_api_keys_revoke: "Revoke",
    studio_api_keys_select_hint: "Select an API key to view details",
    studio_api_keys_permissions: "Permissions",
    studio_api_keys_no_permissions: "No permissions configured",
    studio_api_keys_revoke_confirmation: "Revoke confirmation",
    studio_api_keys_name_label: "Name:",
    studio_api_keys_access_label: "Access:",
    studio_api_keys_admin_granted: "Admin role granted",
    studio_api_keys_admin_granted_hint: "the admin routes and the default_admin policies",
    studio_api_keys_done: "Done",
    studio_api_keys_status_active: "Active",
    studio_api_keys_status_expired: "Expired",
    studio_api_keys_status_revoked: "Revoked",
    studio_api_keys_inactive_heading: "Revoked / Expired",
    studio_api_keys_stat_status: "Status",
    studio_api_keys_stat_last_used: "Last used",
    studio_api_keys_stat_expires: "Expires",
    studio_api_keys_never: "Never",
    studio_api_keys_role_service: "Service",
    studio_api_keys_stat_rate_limit: "Rate limit",
    studio_api_keys_rate_limit_default: "Default (1000/15min)",
    studio_api_keys_stat_created_by: "Created by",
    studio_api_keys_copy_failed: "Failed to copy",
    studio_branches_denied_title: "You cannot list this project's branches",
    studio_branches_denied_hint: "Nothing is wrong with the project. Branching runs on the admin connection, and the signed-in account was refused.",
