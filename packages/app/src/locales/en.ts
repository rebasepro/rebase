...
export const en: RebaseTranslations = {
    ...
    selection_selected_count: "{{selected}} selected",
    selection_select_all_loaded: "Select all loaded rows",
    selection_deselect_all: "Deselect all",
    selection_select_all_matching: "Select all {{total}} {{collection}}",
    selection_select_all_matching_unknown: "Select every matching row",
    selection_all_matching_selected: "All {{total}} {{collection}} are selected",
    selection_all_matching_selected_unknown: "Every row matching the current filter is selected",
