...
export const hi: RebaseTranslations = {
    ...
    auth_account_exists_with_different_credential: "इस ईमेल से एक खाता पहले से मौजूद है। पिछली बार की तरह साइन इन करें।",
    auth_account_exists_sign_in_with_password: "इस ईमेल से एक खाता पहले से मौजूद है। इसके बजाय अपने ईमेल और पासवर्ड से साइन इन करें।",
    ...
    auth_new_password_title: "नया पासवर्ड सेट करें",
    auth_new_password_subtitle: "वह पासवर्ड चुनें जिससे आप अब से साइन इन करेंगे।",
    auth_password_requirements: "पासवर्ड कम से कम 8 अक्षरों का होना चाहिए, जिसमें बड़े और छोटे अक्षर और एक संख्या हो",
    auth_set_password: "पासवर्ड सेट करें",
    auth_password_changed_title: "पासवर्ड बदल गया",
    auth_password_changed_body: "अपने नए पासवर्ड से साइन इन करें।",
    auth_continue_to_sign_in: "साइन इन पर जारी रखें",
    auth_link_invalid_or_expired: "यह लिंक अमान्य है या इसकी समय-सीमा समाप्त हो गई है। साइन-इन स्क्रीन से नया लिंक मंगवाएँ।",
    auth_password_reset_unavailable: "इस बैकएंड पर पासवर्ड रीसेट उपलब्ध नहीं है।",
    auth_verifying_email: "आपके ईमेल पते की पुष्टि हो रही है…",
    auth_email_verified_title: "ईमेल की पुष्टि हो गई",
    ...
    studio_rls_edit_generated: "{{policy}} को Rebase हर कलेक्शन के लिए बनाता है, इसलिए संपादित करने के लिए आपका कोई नियम नहीं है। इसके बजाय अपनी पॉलिसी जोड़ें।",
    studio_rls_edit_not_declared: "{{policy}} केवल डेटाबेस में मौजूद है, इसलिए आपके कोड में संपादित करने के लिए कोई नियम नहीं है। पहले इसे कोडबेस में इम्पोर्ट करें।",
    studio_rls_edit_several_operations: "{{policy}} उन पॉलिसियों में से एक है जिनमें एक ही नियम कंपाइल होता है, हर ऑपरेशन के लिए एक। उस नियम को कलेक्शन की सोर्स फ़ाइल में संपादित करें।",
    ...
    studio_cron_logs_read_failed: "इस जॉब के रन नहीं पढ़े जा सके",
    studio_cron_logs_denied_title: "आप इस जॉब के रन नहीं पढ़ सकते",
    ...
    studio_api_keys_empty_title: "अभी तक कोई API कुंजी नहीं",
    studio_api_keys_empty_hint: "सेवाओं के बीच प्रमाणीकरण सक्षम करने के लिए एक कुंजी बनाएँ",
    studio_api_keys_revoke: "निरस्त करें",
    studio_api_keys_select_hint: "विवरण देखने के लिए एक API कुंजी चुनें",
    studio_api_keys_permissions: "अनुमतियाँ",
    studio_api_keys_no_permissions: "कोई अनुमति कॉन्फ़िगर नहीं की गई",
    studio_api_keys_revoke_confirmation: "निरस्तीकरण की पुष्टि",
    studio_api_keys_name_label: "नाम:",
    studio_api_keys_access_label: "पहुँच:",
    studio_api_keys_admin_granted: "व्यवस्थापक भूमिका प्रदान की गई",
    studio_api_keys_admin_granted_hint: "व्यवस्थापक रूट और default_admin नीतियाँ",
    studio_api_keys_done: "हो गया",
    studio_api_keys_status_active: "सक्रिय",
    studio_api_keys_status_expired: "समाप्त",
    studio_api_keys_status_revoked: "निरस्त",
    studio_api_keys_inactive_heading: "निरस्त / समाप्त",
    studio_api_keys_stat_status: "स्थिति",
    studio_api_keys_stat_last_used: "अंतिम उपयोग",
    studio_api_keys_stat_expires: "समाप्ति",
    studio_api_keys_never: "कभी नहीं",
    studio_api_keys_role_service: "सेवा",
    studio_api_keys_stat_rate_limit: "दर सीमा",
    studio_api_keys_rate_limit_default: "डिफ़ॉल्ट (1000/15 मिनट)",
    studio_api_keys_stat_created_by: "निर्माता",
    studio_api_keys_copy_failed: "कॉपी नहीं हो सका",
