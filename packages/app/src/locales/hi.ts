...
export const hi: RebaseTranslations = {
    ...
    selection_selected_count: "{{selected}} चयनित",
    selection_select_all_loaded: "लोड की गई पंक्तियाँ चुनें",
    selection_deselect_all: "सभी अचयनित करें",
    selection_select_all_matching: "सभी {{total}} {{collection}} चुनें",
    selection_select_all_matching_unknown: "मेल खाने वाली सभी पंक्तियाँ चुनें",
    selection_all_matching_selected: "सभी {{total}} {{collection}} चयनित हैं",
    selection_all_matching_selected_unknown: "वर्तमान फ़िल्टर से मेल खाने वाली सभी पंक्तियाँ चयनित हैं",
    selection_clear: "चयन हटाएँ",
