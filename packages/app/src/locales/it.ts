...
export const it: RebaseTranslations = {
    ...
    selection_selected_count: "{{selected}} selezionati",
    selection_select_all_loaded: "Seleziona le righe caricate",
    selection_deselect_all: "Deseleziona tutto",
    selection_select_all_matching: "Seleziona tutti i {{total}} {{collection}}",
    selection_select_all_matching_unknown: "Seleziona tutte le righe corrispondenti",
    selection_all_matching_selected: "Tutti i {{total}} {{collection}} sono selezionati",
    selection_all_matching_selected_unknown: "Tutte le righe che corrispondono al filtro attuale sono selezionate",
