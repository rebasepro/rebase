...
export const it: RebaseTranslations = {
    ...
    auth_account_exists_with_different_credential: "Esiste già un account con questo indirizzo email. Accedi come hai fatto l'ultima volta.",
    auth_account_exists_sign_in_with_password: "Esiste già un account con questo indirizzo email. Accedi con email e password.",
    ...
    auth_new_password_title: "Imposta una nuova password",
    auth_new_password_subtitle: "Scegli la password con cui accederai d'ora in poi.",
    auth_password_requirements: "La password deve avere almeno 8 caratteri, con maiuscole, minuscole e un numero",
    auth_set_password: "Imposta password",
    auth_password_changed_title: "Password modificata",
    auth_password_changed_body: "Accedi con la tua nuova password.",
    auth_continue_to_sign_in: "Continua all'accesso",
    auth_link_invalid_or_expired: "Questo link non è valido o è scaduto. Richiedine uno nuovo dalla schermata di accesso.",
    auth_password_reset_unavailable: "Il ripristino della password non è disponibile su questo backend.",
    auth_verifying_email: "Conferma del tuo indirizzo email in corso…",
    auth_email_verified_title: "Email confermata",
    ...
    studio_sql_explain_single_statement: "Explain funziona su una sola istruzione alla volta. Seleziona l'istruzione da spiegare e riprova.",
    ...
    studio_rls_edit_generated: "{{policy}} è generata da Rebase per ogni collection, quindi non c'è una tua regola da modificare. Aggiungi invece una policy tua.",
    studio_rls_edit_not_declared: "{{policy}} esiste solo nel database, quindi nel tuo codice non c'è una regola da modificare. Importala prima nel codice.",
    studio_rls_edit_several_operations: "{{policy}} è una delle policy in cui viene compilata una singola regola, una per operazione. Modifica quella regola nel file sorgente della collection.",
    ...
    studio_cron_logs_read_failed: "Non è stato possibile leggere le esecuzioni di questo processo",
    studio_cron_logs_denied_title: "Non puoi leggere le esecuzioni di questo processo",
    ...
    studio_api_keys_empty_title: "Ancora nessuna chiave API",
    studio_api_keys_empty_hint: "Crea una chiave per abilitare l'autenticazione tra servizi",
    studio_api_keys_revoke: "Revoca",
    studio_api_keys_select_hint: "Seleziona una chiave API per vederne i dettagli",
    studio_api_keys_permissions: "Permessi",
    studio_api_keys_no_permissions: "Nessun permesso configurato",
    studio_api_keys_revoke_confirmation: "Conferma della revoca",
    studio_api_keys_name_label: "Nome:",
    studio_api_keys_access_label: "Accesso:",
    studio_api_keys_admin_granted: "Ruolo di amministratore concesso",
    studio_api_keys_admin_granted_hint: "le route di amministrazione e le policy default_admin",
    studio_api_keys_done: "Fatto",
    studio_api_keys_status_active: "Attiva",
    studio_api_keys_status_expired: "Scaduta",
    studio_api_keys_status_revoked: "Revocata",
    studio_api_keys_inactive_heading: "Revocate / Scadute",
    studio_api_keys_stat_status: "Stato",
    studio_api_keys_stat_last_used: "Ultimo utilizzo",
    studio_api_keys_stat_expires: "Scade",
    studio_api_keys_never: "Mai",
    studio_api_keys_role_service: "Servizio",
    studio_api_keys_stat_rate_limit: "Limite di richieste",
    studio_api_keys_rate_limit_default: "Predefinito (1000/15 min)",
    studio_api_keys_stat_created_by: "Creata da",
    studio_api_keys_copy_failed: "Copia non riuscita",
