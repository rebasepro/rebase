...
export function parseQueryOptions(
    ...
    // request that needs the parameter.
    const reservedQueryKeys = ["limit", "offset", "page", "after", "orderBy", "include", "fields", "distinct", "searchString", "searchExplain", "vector_search", "vector", "vector_distance", "vector_threshold", "or", "and", "not", "where", "select", "groupBy"];
