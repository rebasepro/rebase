...
export const BooleanSwitch = React.forwardRef(function BooleanSwitch({
        ...
        return <button
            ...
            className={cls(
                ...
                // rendered identically and the prop looked inert.
                {
                    smallest: "w-[34px] h-[18px] min-w-[34px] min-h-[18px]",
                    small: "w-[38px] h-[22px] min-w-[38px] min-h-[22px]",
                    medium: "w-[44px] h-[26px] min-w-[44px] min-h-[26px]",
                    large: "w-[52px] h-[30px] min-w-[52px] min-h-[30px]"
                }[size],
