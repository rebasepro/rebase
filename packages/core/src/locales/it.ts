...
export const it: RebaseTranslations = {
    ...
    add: "Aggiungi",
    remove: "Rimuovi",
    multiple_entitys: "Entità multiple",
    ...
    kanban_view: "Kanban",
    choose_how_entitys_displayed_default: "Scegli come debbano essere visualizzate le entità di default",
    ...
    entitys_with_same_id_overwritten: "Le entità con lo stesso id verranno sovrascritte",
    ...
    create_entitys: "Crea entità",
    read_entitys: "Leggi entità",
    update_entitys: "Aggiorna entità",
    delete_entitys: "Elimina entità",
    all_collections: "Tutte le collezioni",
    create_entitys_in_collections: "Crea entità nelle collezioni",
    ...
    entitys_will_be_overwritten: "Le entità esistenti con lo stesso ID verranno sovrascritte",
    ...
    some_entitys_deleted: "Alcune entità sono state eliminate, ma non tutte",
    error_deleting_entitys: "Errore durante l'eliminazione delle entità",
    deleted: "eliminata",
