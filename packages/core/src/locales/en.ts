...
export const en: RebaseTranslations = {
    ...
    copy: "Copy",
    delete: "Delete",
    delete_not_allowed: "You have selected at least one snapshot you cannot delete",
    edit_snapshot: "Edit",
    back_to_detail: "Back to details",

    // ─── Delete dialog ───────────────────────────────────────────
    delete_confirmation_title: "Delete?",
    delete_confirmation_body: "This will delete the snapshot. Are you sure?",
    delete_multiple_confirmation_body: "This will delete the selected snapshots. Are you sure?",
    ...
    find_snapshot_by_id: "Find snapshot by ID",
    filter: "Filter",
    filters: "Filters",
    ...
    add: "Add",
    remove: "Remove",
    multiple_snapshots: "Multiple snapshots",
    ...
    snapshot_does_not_exist: "This snapshot does not exist in the database",
    ...
    unsaved_changes_in_snapshot: "You have unsaved changes in this snapshot.",
    ...
    cannot_delete_selected: "You have selected at least one snapshot you cannot delete",
    ...
    edit_name: "Edit {{name}}",
    this_snapshot_not_exist: "This snapshot does not exist in the database",
    ...
    // ─── Snapshot Edit View ─────────────────────────────────────────
    youd_need_to_save_before_additional_collections: "You need to save your snapshot before adding additional collections",
    ...
    cards_view: "Cards",
    kanban_view: "Kanban",
    choose_how_snapshots_displayed_default: "Choose how snapshots should be displayed by default",
    ...
    singular_name_description: "Optionally define a singular name for your snapshots",
    ...
    config_doc_id_generation: "Configure how document IDs are generated when creating new snapshots.",
    ...
    add_custom_snapshot_action: "Add custom snapshot action",
    ...
    add_custom_snapshot_view: "Add custom snapshot view",
    ...
    snapshots_with_same_id_overwritten: "Snapshots with the same id will be overwritten",
    ...
    create_snapshots_in_collections: "Create snapshots in collections",
    ...
    all: "All",
    customise_permissions_description: "You can customise the permissions that the users related to this role can perform in the snapshots of each collection",
    ...
    snapshots_will_be_overwritten: "Snapshots with the same id will be overwritten",
    ...
    kanban_view_requires_enum: "Kanban view requires a string property with enum values to group snapshots into columns. Please add an enum property to your collection schema to use this view.",
    ...
    delete_snapshot_confirm_title: "Would you like to delete this {{snapshotName}}?",
    no_filter: "No filter",
    is_true: "is true",
    is_false: "is false",
    ...
    some_snapshots_deleted: "Some of the snapshots have been deleted, but not all",
    error_deleting_snapshots: "Error deleting snapshots",
    deleted: "Deleted",
    ...
    required_tooltip: "You won't be able to save this snapshot if this value is not set",
    unique_tooltip: "There cannot be multiple snapshots with the same value",
    lowercase: "Lowercase",
    uppercase: "Uppercase",
    trim: "Trim",
    ...
    kanban_column_description: "Select a string property with enum values to group snapshots into columns",
    ...
    side_dialog_width_description: "Optionally define the width (in pixels) of snapshots side dialog. Default is 768px",
    ...
    studio_sql_edit_snapshot: "Open {{name}} #{{id}}",
