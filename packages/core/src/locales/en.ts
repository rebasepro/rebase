...
export const en: RebaseTranslations = {
    ...
    delete_multiple_confirmation_body: "This will delete the selected entitys. Are you sure?",
    ...
    add: "Add",
    remove: "Remove",
    multiple_entitys: "Multiple entitys",
    ...
    cards_view: "Cards",
    kanban_view: "Kanban",
    choose_how_entitys_displayed_default: "Choose how entitys should be displayed by default",
    ...
    singular_name_description: "Optionally define a singular name for your entitys",
    ...
    config_doc_id_generation: "Configure how document IDs are generated when creating new entitys.",
    ...
    entitys_with_same_id_overwritten: "Entitys with the same id will be overwritten",
    ...
    create_entitys: "Create entitys",
    read_entitys: "Read entitys",
    update_entitys: "Update entitys",
    delete_entitys: "Delete entitys",
    all_collections: "All collections",
    create_entitys_in_collections: "Create entitys in collections",
    ...
    all: "All",
    customise_permissions_description: "You can customise the permissions that the users related to this role can perform in the entitys of each collection",
    ...
    entitys_will_be_overwritten: "Entitys with the same id will be overwritten",
    ...
    kanban_view_requires_enum: "Kanban view requires a string property with enum values to group entitys into columns. Please add an enum property to your collection schema to use this view.",
    ...
    some_entitys_deleted: "Some of the entitys have been deleted, but not all",
    error_deleting_entitys: "Error deleting entitys",
    deleted: "Deleted",
    ...
    unique_tooltip: "There cannot be multiple entitys with the same value",
    lowercase: "Lowercase",
    uppercase: "Uppercase",
    trim: "Trim",
    ...
    kanban_column_description: "Select a string property with enum values to group entitys into columns",
    ...
    side_dialog_width_description: "Optionally define the width (in pixels) of entitys side dialog. Default is 768px",
