...
export const de: RebaseTranslations = {
    ...
    find_snapshot_by_id: "Entität nach ID suchen",
    filter: "Filter",
    filters: "Filter",
    ...
    add: "Hinzufügen",
    remove: "Entfernen",
    multiple_snapshots: "Mehrere Entitäten",
    ...
    error_saving_snapshot: "Fehler beim Speichern des Eintrags",
    snapshot_does_not_exist: "Dieser Eintrag existiert nicht in der Datenbank",
    ...
    snapshot_not_found: "Entität nicht gefunden",
    file_not_found: "Datei nicht gefunden",
    unsaved_changes_in_snapshot: "Sie haben ungespeicherte Änderungen in dieser Entität.",
    ...
    this_snapshot_not_exist: "Diese Entität existiert nicht in der Datenbank",
    ...
    cards_view: "Karten",
    kanban_view: "Kanban",
    choose_how_snapshots_displayed_default: "Wählen Sie aus, wie Entitäten standardmäßig angezeigt werden sollen",
    ...
    add_custom_snapshot_action: "Benutzerdefinierte Entitätsaktion hinzufügen",
    ...
    add_custom_snapshot_view: "Benutzerdefinierte Entitätsansicht hinzufügen",
    ...
    snapshots_with_same_id_overwritten: "Entitäten mit derselben ID werden überschrieben",
    ...
    create_snapshots: "Entitäten erstellen",
    read_snapshots: "Entitäten lesen",
    update_snapshots: "Entitäten aktualisieren",
    delete_snapshots: "Entitäten löschen",
    all_collections: "Alle Sammlungen",
    create_snapshots_in_collections: "Entitäten in Sammlungen erstellen",
    ...
    snapshots_saved: "Entitäten gespeichert",
    ...
    snapshots_will_be_overwritten: "Entitäten mit derselben ID werden überschrieben",
    ...
    delete_snapshot_confirm_title: "Möchten Sie dieses {{snapshotName}} löschen?",
    multiple_deleted: "Mehrere gelöscht",
    some_snapshots_deleted: "Einige der Entitäten wurden gelöscht, aber nicht alle",
    error_deleting_snapshots: "Fehler beim Löschen der Entitäten",
    deleted: "gelöscht",
