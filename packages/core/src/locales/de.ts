...
export const de: RebaseTranslations = {
    ...
    add: "Hinzufügen",
    remove: "Entfernen",
    multiple_entitys: "Mehrere Entitäten",
    ...
    cards_view: "Karten",
    kanban_view: "Kanban",
    choose_how_entitys_displayed_default: "Wählen Sie aus, wie Entitäten standardmäßig angezeigt werden sollen",
    ...
    entitys_with_same_id_overwritten: "Entitäten mit derselben ID werden überschrieben",
    ...
    create_entitys: "Entitäten erstellen",
    read_entitys: "Entitäten lesen",
    update_entitys: "Entitäten aktualisieren",
    delete_entitys: "Entitäten löschen",
    all_collections: "Alle Sammlungen",
    create_entitys_in_collections: "Entitäten in Sammlungen erstellen",
    ...
    entitys_saved: "Entitäten gespeichert",
    ...
    entitys_will_be_overwritten: "Entitäten mit derselben ID werden überschrieben",
    ...
    some_entitys_deleted: "Einige der Entitäten wurden gelöscht, aber nicht alle",
    error_deleting_entitys: "Fehler beim Löschen der Entitäten",
    deleted: "gelöscht",
