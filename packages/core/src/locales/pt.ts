...
export const pt: RebaseTranslations = {
    ...
    find_snapshot_by_id: "Encontrar entidade por ID",
    filter: "Filtrar",
    filters: "Filtros",
    ...
    add: "Adicionar",
    remove: "Remover",
    multiple_snapshots: "Múltiplas entidades",
    ...
    error_saving_snapshot: "Erro ao guardar a entidade",
    snapshot_does_not_exist: "Esta entidade não existe na base de dados",
    ...
    snapshot_not_found: "Entidade não encontrada",
    file_not_found: "Ficheiro não encontrado",
    unsaved_changes_in_snapshot: "Tem alterações não guardadas nesta entidade.",
    ...
    this_snapshot_not_exist: "Esta entidade não existe na base de dados",
    ...
    cards_view: "Cartões",
    kanban_view: "Kanban",
    choose_how_snapshots_displayed_default: "Escolha como as entidades devem ser exibidas por padrão",
    ...
    add_custom_snapshot_action: "Adicionar ação de entidade personalizada",
    ...
    add_custom_snapshot_view: "Adicionar vista de entidade personalizada",
    ...
    snapshots_with_same_id_overwritten: "Entidades com o mesmo id serão substituídas",
    ...
    create_snapshots: "Criar entidades",
    read_snapshots: "Ler entidades",
    update_snapshots: "Atualizar entidades",
    delete_snapshots: "Eliminar entidades",
    all_collections: "Todas as coleções",
    create_snapshots_in_collections: "Criar entidades em coleções",
    ...
    snapshots_will_be_overwritten: "Entidades com o mesmo id serão substituídas",
    ...
    delete_snapshot_confirm_title: "Deseja eliminar este/a {{snapshotName}}?",
    multiple_deleted: "Exclusão múltipla",
    some_snapshots_deleted: "Algumas entidades foram excluídas, mas não todas",
    error_deleting_snapshots: "Erro ao excluir entidades",
    deleted: "excluído(a)",
