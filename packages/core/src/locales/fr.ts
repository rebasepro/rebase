...
export const fr: RebaseTranslations = {
    ...
    add: "Ajouter",
    remove: "Supprimer",
    multiple_entitys: "Entités multiples",
    ...
    cards_view: "Cartes",
    kanban_view: "Kanban",
    choose_how_entitys_displayed_default: "Choisissez comment les entités doivent être affichées par défaut",
    ...
    entitys_with_same_id_overwritten: "Les entités avec le même identifiant seront écrasées",
    ...
    create_entitys: "Créer des entités",
    read_entitys: "Lire des entités",
    update_entitys: "Mettre à jour des entités",
    delete_entitys: "Supprimer des entités",
    all_collections: "Toutes les collections",
    create_entitys_in_collections: "Créer des entités dans les collections",
    ...
    entitys_saved: "entités enregistrées",
    ...
    entitys_will_be_overwritten: "Les entités avec le même identifiant seront écrasées",
    ...
    some_entitys_deleted: "Certaines des entités ont été supprimées, mais pas toutes",
    error_deleting_entitys: "Erreur lors de la suppression des entités",
    deleted: "supprimé",
