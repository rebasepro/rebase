...
export const fr: RebaseTranslations = {
    ...
    find_snapshot_by_id: "Rechercher l'entité par ID",
    filter: "Filtrer",
    filters: "Filtres",
    ...
    add: "Ajouter",
    remove: "Supprimer",
    multiple_snapshots: "Entités multiples",
    ...
    error_saving_snapshot: "Erreur lors de l'enregistrement de l'entité",
    snapshot_does_not_exist: "Cette entité n'existe pas dans la base de données",
    ...
    snapshot_not_found: "Entité non trouvée",
    file_not_found: "Fichier non trouvé",
    unsaved_changes_in_snapshot: "Vous avez des modifications non enregistrées dans cette entité.",
    ...
    this_snapshot_not_exist: "Cette entité n'existe pas dans la base de données",
    ...
    cards_view: "Cartes",
    kanban_view: "Kanban",
    choose_how_snapshots_displayed_default: "Choisissez comment les entités doivent être affichées par défaut",
    ...
    add_custom_snapshot_action: "Ajouter une action d'entité personnalisée",
    ...
    add_custom_snapshot_view: "Ajouter une vue d'entité personnalisée",
    ...
    snapshots_with_same_id_overwritten: "Les entités avec le même identifiant seront écrasées",
    ...
    create_snapshots: "Créer des entités",
    read_snapshots: "Lire des entités",
    update_snapshots: "Mettre à jour des entités",
    delete_snapshots: "Supprimer des entités",
    all_collections: "Toutes les collections",
    create_snapshots_in_collections: "Créer des entités dans les collections",
    ...
    snapshots_saved: "entités enregistrées",
    ...
    snapshots_will_be_overwritten: "Les entités avec le même identifiant seront écrasées",
    ...
    delete_snapshot_confirm_title: "Souhaitez-vous supprimer {{snapshotName}} ?",
    multiple_deleted: "Suppression multiple terminée",
    some_snapshots_deleted: "Certaines des entités ont été supprimées, mais pas toutes",
    error_deleting_snapshots: "Erreur lors de la suppression des entités",
    deleted: "supprimé",
