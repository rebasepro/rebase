...
export const es: RebaseTranslations = {
    ...
    find_snapshot_by_id: "Buscar entidad por ID",
    filter: "Filtrar",
    filters: "Filtros",
    ...
    add: "Añadir",
    remove: "Quitar",
    multiple_snapshots: "Múltiples entidades",
    ...
    error_saving_snapshot: "Error al guardar la entidad",
    snapshot_does_not_exist: "Esta entidad no existe en la base de datos",
    ...
    snapshot_not_found: "Entidad no encontrada",
    file_not_found: "Archivo no encontrado",
    unsaved_changes_in_snapshot: "Tienes cambios sin guardar en esta entidad.",
    ...
    this_snapshot_not_exist: "Esta entidad no existe en la base de datos",
    ...
    cards_view: "Tarjetas",
    kanban_view: "Kanban",
    choose_how_snapshots_displayed_default: "Elige cómo se deben mostrar por defecto las entidades",
    ...
    add_custom_snapshot_action: "Añadir acción personalizada de entidad",
    ...
    add_custom_snapshot_view: "Añadir vista de entidad personalizada",
    ...
    snapshots_with_same_id_overwritten: "Las entidades con el mismo id se sobrescribirán",
    ...
    create_snapshots: "Crear entidades",
    read_snapshots: "Leer entidades",
    update_snapshots: "Actualizar entidades",
    delete_snapshots: "Eliminar entidades",
    all_collections: "Todas las colecciones",
    create_snapshots_in_collections: "Crear entidades en colecciones",
    ...
    snapshots_saved: "entidades guardadas",
    ...
    snapshots_will_be_overwritten: "Las entidades con el mismo ID se sobrescribirán",
    ...
    delete_snapshot_confirm_title: "¿Confirmas que quieres borrar el elemento '{{snapshotName}}'?",
    multiple_deleted: "Múltiples eliminados",
    some_snapshots_deleted: "Algunas entidades han sido eliminadas, pero no todas",
    error_deleting_snapshots: "Error al eliminar entidades",
    deleted: "eliminado",
