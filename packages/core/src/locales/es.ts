...
export const es: RebaseTranslations = {
    ...
    add: "Añadir",
    remove: "Quitar",
    multiple_entitys: "Múltiples entidades",
    ...
    cards_view: "Tarjetas",
    kanban_view: "Kanban",
    choose_how_entitys_displayed_default: "Elige cómo se deben mostrar por defecto las entidades",
    ...
    entitys_with_same_id_overwritten: "Las entidades con el mismo id se sobrescribirán",
    ...
    create_entitys: "Crear entidades",
    read_entitys: "Leer entidades",
    update_entitys: "Actualizar entidades",
    delete_entitys: "Eliminar entidades",
    all_collections: "Todas las colecciones",
    create_entitys_in_collections: "Crear entidades en colecciones",
    ...
    entitys_saved: "entidades guardadas",
    ...
    entitys_will_be_overwritten: "Las entidades con el mismo ID se sobrescribirán",
    ...
    some_entitys_deleted: "Algunas entidades han sido eliminadas, pero no todas",
    error_deleting_entitys: "Error al eliminar entidades",
    deleted: "eliminado",
