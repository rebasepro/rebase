export const iconSynonyms = {
    ...
    border_all: "doc editing editor table stroke text type writing",
    border_bottom: "doc editing editor table stroke text type writing",
    border_clear: "doc editing editor table stroke text type writing",
    border_color: "all create doc editing editor marker pencil table stroke text type writing",
    border_horizontal: "doc editing editor table stroke text type writing",
    border_inner: "doc editing editor table stroke text type writing",
    border_left: "doc editing editor table stroke text type writing",
    border_outer: "doc editing editor table stroke text type writing",
    border_right: "doc editing editor table stroke text type writing",
    border_style: "color doc editing editor table stroke text type writing",
    border_top: "doc editing editor table stroke text type writing",
    border_vertical: "doc editing editor table stroke text type writing",
    ...
    format_align_center: "alignment doc editing editor lines table text type writing",
    format_align_justify: "alignment density doc editing editor extra lines small table text type writing",
    format_align_left: "alignment doc editing editor lines table text type writing",
    format_align_right: "alignment doc editing editor lines table text type writing",
    format_bold: "B alphabet character doc editing editor font letter table styles symbol text type writing",
    format_clear: "T alphabet character disabled doc editing editor enabled font letter off slash table style symbol text type writing",
    format_color_fill: "bucket doc editing editor paint table style text type writing",
    format_color_reset: "clear disabled doc droplet editing editor enabled fill liquid off on paint slash table style text type water writing",
    format_color_text: "doc editing editor fill paint table style type writing",
    format_indent_decrease: "alignment doc editing editor indentation paragraph table text type writing",
    format_indent_increase: "alignment doc editing editor indentation paragraph table text type writing",
    format_italic: "alphabet character doc editing editor font letter table style symbol text type writing",
    format_line_spacing: "alignment doc editing editor table text type writing",
    format_list_bulleted: "alignment doc editing editor notes table task text todo type writing",
    format_list_numbered: "alignment digit doc editing editor notes table symbol task text todo type writing",
    format_list_numbered_rtl: "alignment digit doc editing editor notes table symbol task text todo type writing",
    format_overline: "alphabet character doc editing editor font letter table style symbol text type under writing",
    format_paint: "brush color doc editing editor fill paintroller table style text type writing",
    format_quote: "doc editing editor quotation table text type writing",
    format_shapes: "alphabet character color doc editing editor fill font letter paint table style symbol text type writing",
    format_size: "alphabet character color doc editing editor fill font letter paint table style symbol text type writing",
    format_strikethrough: "alphabet character doc editing editor font letter table style symbol text type writing",
    format_textdirection_l_to_r: "alignment doc editing editor ltr paragraph table type writing",
    format_textdirection_r_to_l: "alignment doc editing editor paragraph rtl table type writing",
    format_underlined: "alphabet character doc editing editor font letter table style symbol text type writing",
    ...
    functions: "average calculate count doc editing editor math sigma table style sum text type writing",
    ...
    height: "arrows color doc down editing editor fill format paint resize table stretch style text type up writing",
    ...
    highlight: "color doc editing editor emphasize fill flashlight format marker paint table style text type writing",
    ...
    strikethrough_s: "alphabet character cross doc editing editor font letter out table styles symbol text type writing",
    ...
    subscript: "2 doc editing editor gmail novitas table style symbol text writing",
    ...
    superscript: "2 doc editing editor gmail novitas table style symbol text writing",
    ...
    vertical_align_bottom: "alignment arrow doc down editing editor table text type writing",
    vertical_align_center: "alignment arrow doc down editing editor table text type up writing",
    vertical_align_top: "alignment arrow doc editing editor table text type up writing",
    ...
    wrap_text: "arrow doc editing editor table type write writing",
