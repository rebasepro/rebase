...
function GoogleLoginButton({
    ...
    useEffect(() => {
        ...
        if (!googleButtonRef.current || !containerRef.current) return;
    ...
    return (
        ...
        >
            ...
            {/* Invisible Google iframe overlay that captures the click */}
            <div
                ref={googleButtonRef}
                className="absolute inset-0 w-full [&>div]:w-full [&>div]:h-full [&_iframe]:w-full [&_iframe]:h-full"
