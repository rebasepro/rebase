 ...
 */
export interface SnapshotFetchProps<M extends Record<string, any>, USER extends User = User> {
    path: string;
 ...
 * @group Hooks and utilities
 */
export interface SnapshotFetchResult<M extends Record<string, any>> {
    snapshot?: Snapshot<M>,
    dataLoading: boolean,
 ...
 */
export function populateSnapshotFetchCache<M extends Record<string, any>>(path: string, snapshots: Snapshot<M>[]): void {
 ...
 */
export function clearSnapshotFetchCache(): void {
...
export function useSnapshotFetch<M extends Record<string, any>, USER extends User = User>(
    {
        path,
        snapshotId,
        collection,
        databaseId,
        useCache = false
    }: SnapshotFetchProps<M, USER>): SnapshotFetchResult<M> {
