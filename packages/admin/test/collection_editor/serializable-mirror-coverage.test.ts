...
const ADMIN_OPTS = path.join(ROOT, "packages/admin-types/src/types/property_options.ts");
const MIRROR = path.join(ROOT, "packages/admin/src/collection_editor/serializable_types.ts");
...
describe("the serializable mirror covers the types it mirrors", () => {
    ...
    it("names every ComponentRef the serializer strips", () => {
        ...
        const utils = readFileSync(
            path.join(ROOT, "packages/admin/src/collection_editor/serializable_utils.ts"), "utf8");
