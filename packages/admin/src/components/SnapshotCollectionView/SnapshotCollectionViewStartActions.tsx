...
export type SnapshotCollectionViewStartActionsProps<M extends Record<string, unknown>> = {
...
export function SnapshotCollectionViewStartActions<M extends Record<string, unknown>>({
    collection,
    relativePath,
    ...
    compact,
    openNewDocument
}: SnapshotCollectionViewStartActionsProps<M>) {
