...
import type { SnapshotCollection, Property } from "@rebasepro/types";
...
import { useCollectionSlotKeys, resolveSnapshotSlots, type CollectionSlotKeys } from "./useSnapshotPreviewSlots";
import { useCMSContext } from "../../hooks/useCMSContext";
import { resolveSnapshotAction } from "../../util/resolutions";

export type SnapshotCollectionListViewProps<M extends Record<string, unknown> = Record<string, unknown>> = {
 ...
 * - Infinite scroll
 */
export function SnapshotCollectionListView<M extends Record<string, unknown> = Record<string, unknown>>({
    collection,
    tableController,
    onSnapshotClick,
    selectionController,
    ...
    path,
    openSnapshotMode
}: SnapshotCollectionListViewProps<M>) {
    ...
    const slotKeys = useCollectionSlotKeys(
        resolvedCollection as SnapshotCollection<Record<string, unknown>>,
        authController,
                            ...
                            <IconButton
                                ...
                                onClick={(e: React.MouseEvent) => {
                                    ...
                                    action.onClick({
                                        ...
                                        collection,
                                        context: context!,
                                        sideSnapshotController: context?.sideSnapshotController,
                                        selectionController,
