...
export type SnapshotBoardCardProps<M extends Record<string, unknown> = Record<string, unknown>> = BoardItemViewProps<Snapshot<M>> & {
 ...
 */
function SnapshotBoardCardInner<M extends Record<string, unknown> = Record<string, unknown>>({
    item,
    isDragging,
    isGroupedOver,
    style,
...
export const SnapshotBoardCard = memo(SnapshotBoardCardInner) as typeof SnapshotBoardCardInner;

/**
 * Wrapper component that adapts SnapshotBoardCard to BoardItemViewProps interface
 */
export function createSnapshotBoardCardComponent<M extends Record<string, unknown>>(
    collection: SnapshotCollection<M>,
    options: {
        onClick?: (snapshot: Snapshot<M>) => void;
    ...
    return function SnapshotBoardCardWrapper(props: BoardItemViewProps<Snapshot<M>>) {
        return (
            <SnapshotBoardCard
                {...props}
