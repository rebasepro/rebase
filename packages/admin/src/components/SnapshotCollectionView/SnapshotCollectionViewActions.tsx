...
export type SnapshotCollectionViewActionsProps<M extends Record<string, unknown>> = {
...
export function SnapshotCollectionViewActions<M extends Record<string, unknown>>({
    collection,
    relativePath,
    ...
    children,
    openNewDocument
}: SnapshotCollectionViewActionsProps<M>) {
