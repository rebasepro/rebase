...
export type RecordCardBindingProps<M extends Record<string, unknown> = Record<string, unknown>> = {
    snapshot: Snapshot<M>;
 ...
 */
export function RecordCardBinding<M extends Record<string, unknown> = Record<string, unknown>>({
    snapshot,
    collection,
    onClick,
    selected,
