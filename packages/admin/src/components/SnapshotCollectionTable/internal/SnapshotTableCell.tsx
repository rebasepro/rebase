...
interface SnapshotTableCellProps {
...
export const SnapshotTableCell = React.memo<SnapshotTableCellProps>(
    function SnapshotTableCell({
        children,
        actions,
        size,
        selected,
        ...
        return a.error === b.error &&
            ...
            a.frozen === b.frozen;
    }) as React.FunctionComponent<SnapshotTableCellProps>;
