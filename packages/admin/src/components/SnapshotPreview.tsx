...
export type SnapshotPreviewProps = {
    ...
    onSideSnapshotClick?: (snapshot: Snapshot) => void,
};

export type SnapshotPreviewDataProps = {
 ...
 * without any container wrapper. Used internally by SnapshotPreview.
 */
export function SnapshotPreviewData({
    actions,
...
export function SnapshotPreviewWithId({
    snapshotId,
    path,
    ...props
}: Omit<SnapshotPreviewProps, "snapshot"> & {
    ...
    return (
        <SnapshotPreviewContainer
            ...
            <SnapshotPreviewData
                ...
                onSideSnapshotClick={onSideSnapshotClick}
                snapshot={snapshot}
            />
        </SnapshotPreviewContainer>
    );
