...
import { addRecentId } from "../SnapshotCollectionView/utils";
...
export const editSnapshotAction: SnapshotAction = {
    ...
    onClick({
        ...
        if (!sideSnapshotController) {
            throw new Error("INTERNAL: editSnapshotAction: sideSnapshotController is undefined");
        }
...
export const copySnapshotAction: SnapshotAction = {
    ...
    onClick({
        ...
        if (!sideSnapshotController) {
            throw new Error("INTERNAL: copySnapshotAction: sideSnapshotController is undefined");
        }
        highlightSnapshot?.(snapshot);
