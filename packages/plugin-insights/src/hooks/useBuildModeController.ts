...
/**
 * Custom mode controller that uses the 'dark' class instead of data-theme attribute
 * This determines the theme of the CMS
 */
export function useBuildModeController(): ModeController {
    ...
    const prefersDarkModeStorage: boolean | null = localStorage.getItem("prefers-dark-mode") != null
    ...
    const setDocumentMode = (mode: "light" | "dark") => {
        ...
        // Use dark class on both html and body to ensure portaled content gets dark mode
        if (mode === "dark") {
