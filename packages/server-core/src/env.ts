...
export function loadEnv<E extends z.ZodObject<any>>(options: { extend: E }): RebaseEnv & z.infer<E>;
export function loadEnv(options?: { extend?: z.ZodObject<any> }): Record<string, unknown> {
