...
// The File menu groups its items into three visually distinct clusters —
// creation, export, and the destructive action — with a separator between
// each, the clearest showcase of the divider's job.
export const Basic = () => {
