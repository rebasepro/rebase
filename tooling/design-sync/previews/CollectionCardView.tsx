...
import { CollectionCardView } from "@rebasepro/ui";
...
export function ProjectCards() {
    return (
        <div style={{ height: 460 }} className="w-full rounded-lg border border-surface-200 dark:border-surface-800 overflow-hidden">
            <CollectionCardView<SampleProject>
