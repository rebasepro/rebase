...
const NOT_NEW = new Map([
    ...
    ["onResetPassword", "a collection's admin-reset hook, released in 0.6 and never quoted in a note; the Unreleased notes fix what the route does with its result"]
]);
