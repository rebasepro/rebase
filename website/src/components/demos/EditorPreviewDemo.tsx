...
export function EditorPreviewDemo() {
    ...
    return (
        <div className="w-full h-full min-h-[400px] bg-surface-frame flex font-sans select-none pointer-events-none border border-hairline rounded-2xl overflow-hidden">
            {/* Editor Side */}
            <div className="flex-1 flex flex-col border-r border-hairline relative">
                {/* Editor Header */}
                <div className="h-12 border-b border-hairline bg-surface-sheet flex items-center px-4 gap-3 shrink-0">
                    ...
                    <div className={`absolute top-14 left-1/2 -translate-x-1/2 bg-surface-raised border border-hairline-strong shadow-xl rounded-lg px-2 py-1 flex items-center gap-1 transition-all duration-300 ${step >= 2 ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2 pointer-events-none'}`}>
            ...
            <div className="flex-1 flex flex-col bg-[#0A0A0A] relative hidden sm:flex">
                <div className="h-12 border-b border-hairline bg-surface-field flex items-center px-4 gap-3 shrink-0">
