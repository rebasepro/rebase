...
export function EditorMiniDemo() {
    ...
    return (
        <div className="h-32 w-full bg-surface-frame rounded-lg border border-hairline mb-6 overflow-hidden flex flex-col pointer-events-none select-none relative">
            {/* Fake editor toolbar */}
            <div className="h-6 border-b border-hairline bg-surface-raised flex items-center px-2 gap-1 shrink-0">
                <div className="ml-2 h-2 w-4 rounded bg-surface-raised-hover"></div>
                <div className="h-2 w-6 rounded bg-surface-raised-hover"></div>
            </div>
            {/* Editor content */}
            <div className="p-3 flex-1 flex flex-col gap-2 relative">
                <div className="w-2/3 h-2 bg-surface-raised-hover rounded"></div>
                ...
                {step === 2 && (
                    <div className="relative">
                        ...
                        <div className="absolute top-4 left-0 bg-surface-raised border border-hairline-strong rounded shadow-lg p-1 w-24">
                            <div className="bg-surface-raised-hover rounded flex items-center p-1 gap-1">
                ...
                {(step === 3 || step === 4) && (
                    <div className="w-full h-12 bg-surface-raised rounded border border-hairline border-dashed flex items-center justify-center relative overflow-hidden">
