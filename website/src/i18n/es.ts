export const es = {
  ...
  "testimonials.title": "Amado por desarrolladores de todo el mundo.",
  "testimonials.subtitle": "Descubre cómo los ingenieros y líderes de ingeniería construyen más rápido con Rebase.",
  "testimonials.1.name": "Sarah Chen",
  "testimonials.1.handle": "@sarahc_dev",
  "testimonials.1.role": "Staff Engineer",
  "testimonials.1.quote": "Rebase reemplazó tres sistemas separados para nosotros: un panel de administración, una API REST personalizada y nuestros scripts de migración. La generación de esquemas de TypeScript es magia pura.",
  "testimonials.2.name": "Marc Dubois",
  "testimonials.2.handle": "@mdubois",
  "testimonials.2.role": "Desarrollador Principal",
  "testimonials.2.quote": "Construimos nuestro sistema de seguimiento de inventario interno en solo dos días usando Rebase. La sincronización en tiempo real es increíblemente rápida.",
  "testimonials.3.name": "Elena Rostova",
  "testimonials.3.handle": "@elena_codes",
  "testimonials.3.role": "Fundadora, TechFlow",
  "testimonials.3.quote": "La seguridad a nivel de fila configurada directamente en el esquema de TypeScript nos permitió lanzar nuestro SaaS con total cumplimiento desde el primer día.",
  "testimonials.4.name": "Kenji Sato",
  "testimonials.4.handle": "@kenjisato",
  "testimonials.4.role": "Desarrollador Full Stack",
  "testimonials.4.quote": "Como desarrollador, nunca he usado una herramienta que se sienta tan nativa de Postgres. Respeta mi modelo de datos y no me estorba.",
  "testimonials.5.name": "Sophia Martinez",
  "testimonials.5.handle": "@sophia_m",
  "testimonials.5.role": "Vicepresidenta de Ingeniería",
  "testimonials.5.quote": "Nuestros equipos solían pasar el 40% de su tiempo construyendo paneles CRUD. Con Rebase, se concentran completamente en la lógica de negocio central.",
