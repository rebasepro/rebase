export const en = {
  ...
  "roadmap.now.item11": "MongoDB driver (experimental)",
  "roadmap.now.item12": "Rebase Cloud — private beta, running real tenants",
  "roadmap.next.title": "Next",
  "roadmap.next.badge": "In Progress",
  "roadmap.next.item1": "AI SQL generation in editor",
  "roadmap.next.item2": "Live schema editing against a running backend",
  ...
  "roadmap.later.item5": "Push notifications and non-JavaScript SDKs",
  ...
  "pricing.ent.desc": "For teams that need a support commitment, an SLA, and help with the parts specific to them.",
  "pricing.ent.cta": "Contact sales",
  "pricing.ent.feat1": "Everything in Open Source",
  "pricing.ent.feat2": "A named contact, and response times in writing",
  "pricing.ent.feat3": "Dedicated support & onboarding",
  "pricing.ent.feat4": "SLAs and priority bug fixes",
  "pricing.ent.feat5": "Architecture and security review, and custom development",
