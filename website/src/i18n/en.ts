export const en = {
  ...
  "backend.meta.description": "Get an auto-generated backend powered by Hono and Drizzle ORM. Complete with REST, GraphQL, and WebSockets.",
  "ai.meta.title": "AI & Agents Infrastructure — Rebase",
  "ai.meta.description": "Deploy an agent-ready backend on top of Postgres with built-in MCP server, vector support, and DataTalk.",
  ...
  "rebase-vs-hasura.meta.title": "Rebase vs Hasura — GraphQL and Admin Panel Comparison",
  "rebase-vs-hasura.meta.description": "Compare instant GraphQL generation with built-in admin dashboards and TypeScript SDK pipelines.",
