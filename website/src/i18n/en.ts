export const en = {
  ...
  "testimonials.title": "Loved by developers worldwide.",
  "testimonials.subtitle": "See how engineers and engineering leaders are building faster with Rebase.",
  "testimonials.1.name": "Sarah Chen",
  "testimonials.1.handle": "@sarahc_dev",
  "testimonials.1.role": "Staff Engineer",
  "testimonials.1.quote": "Rebase replaced three separate systems for us: an admin panel, a custom REST API, and our database migration scripts. The TypeScript schema generation is pure magic.",
  "testimonials.2.name": "Marc Dubois",
  "testimonials.2.handle": "@mdubois",
  "testimonials.2.role": "Lead Developer",
  "testimonials.2.quote": "We built our internal inventory tracking system in just two days using Rebase. The real-time sync is incredibly fast.",
  "testimonials.3.name": "Elena Rostova",
  "testimonials.3.handle": "@elena_codes",
  "testimonials.3.role": "Founder, TechFlow",
  "testimonials.3.quote": "The row-level security configured directly in the TypeScript schema allowed us to launch our SaaS with full compliance on day one.",
  "testimonials.4.name": "Kenji Sato",
  "testimonials.4.handle": "@kenjisato",
  "testimonials.4.role": "Full Stack Developer",
  "testimonials.4.quote": "As a developer, I've never used a tool that feels so native to Postgres. It respects my data model and stays out of my way.",
  "testimonials.5.name": "Sophia Martinez",
  "testimonials.5.handle": "@sophia_m",
  "testimonials.5.role": "VP of Engineering",
  "testimonials.5.quote": "Our teams used to spend 40% of their time building CRUD panels. With Rebase, they focus entirely on core business logic.",
