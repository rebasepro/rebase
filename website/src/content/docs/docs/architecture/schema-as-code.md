...
3. **Roles and Extension Protection**: Drizzle is configured not to manage database roles (`snapshots.roles: false`) or helper tables from extensions like PostGIS.
