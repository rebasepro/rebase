...
|---|---|---|
| **0.18 – 0.20** | [0.18 → next](/docs/upgrading/0-18-to-next/) | Not released yet: what is merged on `main` and already described in these docs. `context.client.data` stops compiling in a collection callback — query through `context.data`. 0.19 and 0.20 declare no breaking change, so this is one hop from 0.18. |
