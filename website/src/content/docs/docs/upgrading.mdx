...
This guide covers three hops, in the order you have to make them.
...
**Part 3 (sections 14–19) is 0.14 → 0.17.** The admin packages are renamed,
resources are declared rather than configured, and a bundle built before it will
not boot on a current runtime. 0.15 and 0.16 break nothing, so this is one hop
from 0.14. If you are already on 0.16, skip to
[section 14](#14-rebaseproadmin-is-rebaseprocms).
