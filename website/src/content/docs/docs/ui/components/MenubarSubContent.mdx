...
sidebar_label: MenubarSubContent
description: MenubarSubContent — a component from @rebasepro/ui, the library Rebase CMS and Rebase Studio are built from.
---

```ts
import { MenubarSubContent } from "@rebasepro/ui";
```
