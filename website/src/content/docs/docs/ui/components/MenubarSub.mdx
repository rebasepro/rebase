---
title: MenubarSub
sidebar_label: MenubarSub
description: MenubarSub — a component from @rebasepro/ui, the library Rebase CMS and Rebase Studio are built from.
---

```ts
import { MenubarSub } from "@rebasepro/ui";
```
