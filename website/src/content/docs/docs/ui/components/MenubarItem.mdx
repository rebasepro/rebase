---
title: MenubarItem
sidebar_label: MenubarItem
description: MenubarItem — a component from @rebasepro/ui, the library Rebase CMS and Rebase Studio are built from.
---

```ts
import { MenubarItem } from "@rebasepro/ui";
```
