...
| `defaultValue` | `any` | Default value for new entitys |
...
References link to entitys in another collection. They render as a preview card showing the referenced entity's details.
