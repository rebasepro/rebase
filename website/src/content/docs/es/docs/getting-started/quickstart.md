...
slug: es/docs/getting-started/quickstart
...
| `shared/` | Definiciones de colecciones TypeScript compartidas por ambos lados |
...
Abre `shared/collections/` y crea un nuevo archivo:
