...
`$ADMIN_TOKEN` es un token de acceso de administrador — el `accessToken` que
devuelve el inicio de sesión de una cuenta con el rol de administrador. Nada en
la máquina lo define por ti.
