...
|---|---|---|
| **0.18 – 0.20** | [0.18 → next](/docs/upgrading/0-18-to-next/) | Aún no publicado: lo que está fusionado en `main` y ya se describe en esta documentación. `context.client.data` deja de compilar en un callback de colección; consulta a través de `context.data`. 0.19 y 0.20 no declaran cambios incompatibles, por lo que este es un solo salto desde 0.18. |
