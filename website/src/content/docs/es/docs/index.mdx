...
Si te estás conectando a una base de datos existente, puedes realizar la introspección para generar automáticamente tus archivos de colección:
...
Eso es todo. Tu panel de administración se está ejecutando en `http://localhost:5173` y la API en `http://localhost:3001`.

→ Sigue la [guía de Inicio Rápido](/docs/getting-started/quickstart) completa para una explicación detallada.
