...
:::tip
Rebase **no** es un SaaS alojado. Lo auto-alojas, posees tus datos y posees tu código. Piensa en ello como una alternativa de código abierto a Supabase o Retool que controlas de principio a fin.
:::
