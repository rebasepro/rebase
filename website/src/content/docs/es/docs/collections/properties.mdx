...
Las opciones relacionadas con la UI se anidan bajo el sub-objeto `ui`:
...
| Propiedad | Tipo | Descripción |
|----------|------|-------------|
| `ui.readOnly` | `boolean` | Prevenir edición |
| `ui.disabled` | `boolean \| PropertyDisabledConfig` | Deshabilitar con tooltip opcional |
| `ui.hideFromCollection` | `boolean` | Ocultar de la vista de tabla |
| `ui.columnWidth` | `number` | Ancho de columna en píxeles (vista de tabla) |
| `ui.widthPercentage` | `number` | Ancho del campo como porcentaje en la vista de formulario |
| `ui.Field` | `React.ComponentType` | Componente de campo personalizado |
| `ui.Preview` | `React.ComponentType` | Componente de celda de tabla personalizado |
