...
description: Cada cambio incompatible de 0.18 y qué hacer con cada uno.
---

# Actualizar 0.17 → 0.18

**0.18.0 ya está publicada.** Son las entradas `### Breaking` de su
[sección del changelog](/es/docs/changelog/), una a una, con lo que cada una te
