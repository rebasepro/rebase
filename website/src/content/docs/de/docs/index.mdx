...
:::tip
Rebase ist **kein** gehostetes SaaS. Sie hosten es selbst, Sie besitzen Ihre Daten und Sie besitzen Ihren Code. Betrachten Sie es als eine quelloffene Alternative zu Supabase oder Retool, die Sie vollständig kontrollieren.
:::
