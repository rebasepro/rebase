...
|---|---|---|
| **0.18 – 0.20** | [0.18 → next](/docs/upgrading/0-18-to-next/) | Noch nicht veröffentlicht: was auf `main` zusammengeführt und in diesen Docs bereits beschrieben ist. `context.client.data` kompiliert in einem Collection-Callback nicht mehr – führen Sie Abfragen über `context.data` aus. 0.19 und 0.20 deklarieren keine Breaking Changes, daher ist dies ein einziger Schritt ab 0.18. |
