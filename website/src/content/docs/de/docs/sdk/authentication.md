...
### Aktuellen Benutzer abrufen (servergeprüft)
...
## Sitzungsverwaltung (mehrere Geräte)
...
- **[Authentifizierung im Backend](/docs/backend/authentication)** — Serverseitige Authentifizierungskonfiguration
