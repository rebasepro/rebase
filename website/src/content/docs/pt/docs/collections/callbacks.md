...
Chamado **antes que uma leitura seja compilada**, para restringir quais linhas serão solicitadas. Retorne condições para aplicar como AND na consulta; não retorne nada para não adicionar nenhuma.
