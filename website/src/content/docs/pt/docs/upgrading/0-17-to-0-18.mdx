...
description: Cada alteração incompatível da 0.18, e o que fazer em cada uma.
---

# Atualizar 0.17 → 0.18

**A 0.18.0 está publicada.** São as entradas `### Breaking` da sua
[secção do changelog](/pt/docs/changelog/), uma de cada vez, com o que cada uma
