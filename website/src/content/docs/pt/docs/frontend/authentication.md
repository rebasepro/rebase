...
- **`RebaseLoginView`** — Formulário de login/cadastro pré-construído com suporte a OAuth
...
O componente `RebaseLoginView` fornece um formulário completo de login e cadastro:
