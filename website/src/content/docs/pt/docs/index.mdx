...
:::tip
Rebase **não** é um SaaS hospedado. Você o auto-hospeda, você é o proprietário de seus dados e do seu código. Pense nele como uma alternativa de código aberto ao Supabase ou Retool que você controla de ponta a ponta.
:::
