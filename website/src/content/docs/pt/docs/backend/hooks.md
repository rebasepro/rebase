...
- **Callbacks globais**: Definidos em `initializeRebaseBackend({ callbacks })`. Eles disparam em **todas** as coleções, em todos os caminhos de dados (API REST, WebSocket / tempo real, `rebase.data` do lado do servidor).
