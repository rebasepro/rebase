...
Questo legge le tue collezioni da `shared/collections/` e genera `backend/src/schema.generated.ts` con definizioni di tabelle Drizzle, enum e relazioni.
...
```bash
# 1. Modifica la tua collezione in shared/collections/
