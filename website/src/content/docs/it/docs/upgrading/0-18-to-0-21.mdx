...
slug: it/docs/upgrading/0-18-to-0-21
title: Aggiornamento da 0.18 a 0.21
sidebar_label: 0.18 → 0.21
description: Ogni breaking change della 0.21 e cosa fare per ciascuna.
---

# Aggiornamento 0.18 → 0.21

**La 0.21.0 è stata rilasciata.** Queste sono le voci `### Breaking` della sua [sezione del changelog](/docs/changelog/), una alla volta, con ciò che ciascuna ti chiede di modificare. Le versioni 0.19 e 0.20 non dichiarano alcuna breaking change, quindi questo è un singolo passaggio da 0.18 — leggilo prima di passare alla 0.21, non dopo.
