...
`$ADMIN_TOKEN` è un token di accesso amministratore — l'`accessToken` che
restituisce l'accesso di un account con il ruolo admin. Nulla sulla macchina lo
imposta al posto tuo.
