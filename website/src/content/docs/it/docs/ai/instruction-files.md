...
Al suo interno non c'è `REBASE_PROJECT_DIR`, ed è voluto: il client avvia il
server nella radice del progetto, e un percorso assoluto è l'unica riga di quel
file che non può essere committata.
