...
| `isId` | `boolean \| string` | Primary key, and who fills it: `"manual"`, `"uuid"`, `"cuid"`, or any other string used verbatim as the column's SQL default expression. `"increment"` is a **number** strategy and does nothing here |
