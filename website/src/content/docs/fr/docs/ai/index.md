...
que Rebase n'installe pas pour vous.** Et **aucun index ANN n'est créé pour une
colonne vectorielle**, ce qui fait de `vectorSearch` un scan exact — très bien
pour des milliers de lignes, mais pas pour des millions.
