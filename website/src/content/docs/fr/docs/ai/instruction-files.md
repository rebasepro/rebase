...
Il n'y a pas de `REBASE_PROJECT_DIR` dedans, et c'est volontaire : le client
lance le serveur à la racine du projet, et un chemin absolu est la seule ligne de
ce fichier qui ne peut pas être commitée.
