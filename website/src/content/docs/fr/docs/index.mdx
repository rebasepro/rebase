...
:::tip
Rebase n'est **pas** un SaaS hébergé. Vous l'auto-hébergez, vous possédez vos données et vous possédez votre code. Considérez-le comme une alternative open-source à Supabase ou Retool que vous contrôlez de bout en bout.
:::
