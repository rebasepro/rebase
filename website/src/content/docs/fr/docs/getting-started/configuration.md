...
slug: fr/docs/getting-started/configuration
...
|----------|-------------|---------|
| `VITE_API_URL` | URL de l'API backend. Utilisée par le SDK client. | `http://localhost:3001` |
...
| `STORAGE_BASE_PATH` | Chemin de base pour le stockage local | `./uploads` |
