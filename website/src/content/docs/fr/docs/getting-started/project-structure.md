...
slug: fr/docs/getting-started/project-structure
...
- **Routes d'authentification** à `/api/auth/*` — inscription, connexion, rafraîchissement, Google OAuth
...
1. **Vous définissez** les collections dans `shared/`
